...
const s=themedStyleSheet(()=>({
  ...
  runnerDot:{position:'absolute',zIndex:3,width:38,height:38,alignItems:'center',justifyContent:'center',transform:[{translateY:-1}]},runnerImage:{width:34,height:34,borderRadius:9},
